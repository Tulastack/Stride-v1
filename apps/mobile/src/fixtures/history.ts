...
export const uploadOne: AnalysisResult = {
  ...
  metrics: [
    { key: 'knee_drive', measured: band(70, 0.88), unit: '°', normalRange: [85, 100], comparableAcrossViews: true },
    { key: 'trunk_lean', measured: band(44, 0.9), unit: '°', normalRange: [40, 50], comparableAcrossViews: true },
    { key: 'cadence_spm', measured: band(244, 0.9, 4), unit: 'spm', normalRange: [240, 260], comparableAcrossViews: true },
    { key: 'hip_extension', measured: band(168, 0.85), unit: '°', normalRange: [165, 180], comparableAcrossViews: true },
  ],
...
export const uploadTwo: AnalysisResult = {
  ...
  metrics: [
    { key: 'knee_drive', measured: band(82, 0.89), unit: '°', normalRange: [85, 100], comparableAcrossViews: true },
    { key: 'trunk_lean', measured: band(36, 0.9), unit: '°', normalRange: [40, 50], comparableAcrossViews: true },
